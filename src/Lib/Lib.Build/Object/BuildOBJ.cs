...
public enum ReType
{
    ...
    UpdataDll, UpdataClass, UpdataSocket, UpdataWebSocket, UpdataRobot, UpdataMqtt, UpdataTask, UpdataWeb, WebSetIsVue,
    WebRemoveFile, WebAddFile, WebAddCode, WebCodeZIP,
    Check, Login, GetApi,
    SetRobot, GetConfig,
